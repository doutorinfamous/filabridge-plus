...
func TestGenerateBambuConfigurationYAMLNoBareJinjaLines(t *testing.T) {
	printer := BambuPrinter{
		Prefix:              "03919c461204338",
		PrintWeightEntity:   "sensor.bambu_print_weight",
		PrintProgressEntity: "sensor.bambu_print_progress",
	}
	yaml := generateBambuConfigurationYAML(printer.Prefix, CollectBambuTrayInfos(printer), printer, "http://192.168.1.66:5000/api/webhook")
...
func TestGenerateBambuHAPackageContainsUtilityMeter(t *testing.T) {
	printer := BambuPrinter{
		Prefix:              "03919c461204338",
		Name:                "Test A1",
	...
	yaml := GenerateBambuHAPackage(printer, "http://192.168.1.66:5000/api/webhook")
