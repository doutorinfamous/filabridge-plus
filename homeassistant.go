...
// HAClient is a generic Home Assistant REST + WebSocket client.
...
// HAEntityRegistryEntry represents an entity registry entry.
...
// HADeviceRegistryEntry represents a device registry entry.
...
// NewHAClient creates a Home Assistant API client.
...
func (c *HAClient) authRequest(method, path string, body io.Reader) (*http.Response, error) {
...
func (c *HAClient) TestConnection() error {
...
func (c *HAClient) wsCommand(commands []map[string]interface{}) ([][]byte, error) {
...
func (c *HAClient) GetEntityAndDeviceRegistry() ([]HAEntityRegistryEntry, []HADeviceRegistryEntry, error) {
	...
	var entities []HAEntityRegistryEntry
	var devices []HADeviceRegistryEntry
...
func (c *HAClient) GetEntityIdToUniqueIdMap() (map[string]string, error) {
	c.entityMapMu.RLock()
...
func (c *HAClient) ResolveToUniqueID(entityID string, idMap map[string]string) string {
	if idMap != nil {
